...
namespace Netch.Controllers
{
    public abstract class Controller
    {
        ...
        public static Process GetProcess(string fileName, bool redirectStd = true)
        {
            var p = new Process
            {
                StartInfo =
        ...
        protected void OnOutputDataReceived(object sender, DataReceivedEventArgs e)
        {
            ...
            var str = Name == "Redirector" ? e.Data : Encoding.UTF8.GetString(Encoding.GetEncoding("gbk").GetBytes(e.Data ?? string.Empty));
